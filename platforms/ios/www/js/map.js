...
.controller('MCtrl', function($rootScope,$scope,$http,$filter,$timeout,$firebaseArray) {
    var vm = self;
    ...
    document.addEventListener("deviceready", function () {
      ...
      function onMapInit(map) {
		  ...
		  tileUrlFormat: "https://api.mapbox.com/styles/v1/parcl/cizbluem2007h2sqije1p28xa/tiles/256/<zoom>/<x>/<y>@2x?access_token=pk.eyJ1IjoicGFyY2wiLCJhIjoiY2l5ejZ2dTNpMDNxYTJ4bzRybXk2cmZmMCJ9.wmpeDXBu8hGA55bvnjoweg"
