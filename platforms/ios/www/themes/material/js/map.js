...
angular
  ...
  .controller('MCtrl', function($rootScope,$state,$scope,$mdSidenav,$mdBottomSheet,$mdDialog,$mdToast,$http,$filter,$mdMedia,$timeout,$firebaseArray,$sce,$cordovaCamera,fbStorage) {
    ...
    document.addEventListener("deviceready", function () {
      ...
      Mapbox.show(
        {
          style: 'mapbox://styles/parcl/ciz03327d00032srxlt2mxlpm', // light|dark|emerald|satellite|hybrid|streets , default 'streets'
          margins: {
            left: 0, // default 0
            right: 0, // default 0
            // our demo apps have a different layout for Android (tabs at the top)
            top: 0,//navigator.userAgent.indexOf("Android") == -1 ? 316 : 340, // default 0
            bottom: navigator.userAgent.indexOf("Android") == -1 ? 50 : 100 // default 0
          },
          center: { // optional, without a default
            lat: $rootScope.defaultPosition.coords.latitude,
              lng: $rootScope.defaultPosition.coords.longitude
          },
