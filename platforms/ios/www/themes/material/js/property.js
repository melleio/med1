...
function claimProperty(id){
  ...
  vm.getStaticImage = function(x,y){
    ...
    return "https://maps.googleapis.com/maps/api/staticmap?currentParceler="+y+","+x+"&markers=color:green%7C"+y+","+x+"&zoom=18&format=png&sensor=false&size=320x240&maptype=roadmap&style=feature:road%7Chue:0x006eff&style=feature:water%7Chue:0x004cff%7Clightness:-45&key="+key;
  }
