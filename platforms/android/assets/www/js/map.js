...
.controller('MCtrl', function($rootScope,$scope,$http,$filter,$timeout,$firebaseArray) {
    ...
    document.addEventListener("deviceready", function () {
      ...
      function onMapInit(map) {
		  ...
		  tileUrlFormat: "https://api.mapbox.com/styles/v1/parcl/ciz03327d00032srxlt2mxlpm/tiles/256/<zoom>/<x>/<y>?access_token=pk.eyJ1IjoicGFyY2wiLCJhIjoiY2l5ejZ2dTNpMDNxYTJ4bzRybXk2cmZmMCJ9.wmpeDXBu8hGA55bvnjoweg"
