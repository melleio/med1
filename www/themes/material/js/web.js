"use strict";
var ang = angular
  .module('materialApp', ['ngMaterial',"firebase"])
...
.controller('DashCtrl', function($rootScope,$scope,$mdBottomSheet,$mdDialog,$mdToast,$http,$filter,$mdMedia,$firebaseArray,$firebaseObject) {
